    ...
    try
     {
        ...
        ResultSet rs=st.executeQuery("select * from files where owner='"+username+"'");
        %>
<html>
    ...
    <body>
        ...
        <div id="content">
            <div id="p" style="background-color: white;width:auto;height:auto;margin: 100px;"><br><br>
                ...
                <table style=" align-content: center; margin-top: 0px;border: solid black; margin-left: 100px;" cellpadding="10px"  border="1px" align="center">
                    <tr>
