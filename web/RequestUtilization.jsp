    ...
    <body>
        <div id="image">
           ...
           <ul>
                ...
                <li>
                     <a href="RequestUtilization.jsp">Requests Utilization</a>
                </li>
                 <li>
                     <a href="MemoryUtilization.jsp">Memory Utilization</a>
                </li>
                 
                <li>
                     <a href="VMViewFiles.jsp">View Files</a>
                </li>
                <li>
                     <a href="VM.jsp">Home</a>
                </li>
            </ul>
        ...
        <div id="content">
            <div id="p" style="background-color: white;width:auto;height:auto;"><br><br>
                ...
                <center> <iframe src="RequestUtil" width="800" height="450" style="border:none;"></iframe></center>
            </div>
            </div>
