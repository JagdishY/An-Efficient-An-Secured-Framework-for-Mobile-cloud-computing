    ...
    try
     {
        ...
        ResultSet rs=st.executeQuery("select * from user where status='Waiting' or status='Activated' ");
        %>
<html>
                     ...
                     <td><%=rs.getString(2)%></td>
                      <td><%=rs.getString(4)%></td>
                       <td><%=rs.getString(5)%></td>
                        ...
                        <td><a href="deactivate.jsp?uname=<%=rs.getString(1)%>&email=<%=rs.getString(2)%>"><font style="bold" size="5" color="green">Deactivate</font></a></td>
