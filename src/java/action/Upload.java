                    ...
                    while (it.hasNext()) {
                        ...
                        if (isFormField) {
                            ...
                            try {
                                ...
                                pstm = con.prepareStatement("insert into files (file, keyword, filetype, filename, CDate, owner, size, data, frank, file_key,status)values(?,?,?,?,?,?,?,?,?,?,'Waiting')");
                                ...
                                /*Cloud Start*/
                                File f = new File("F:\\",fileItem.getName());
                                ...
                                if (i == 1) {
                                    ...
                                    response.sendRedirect("UserHome.jsp?msgg=failed");
                                }
                                con.close();
                            } catch (Exception e) {
